...
## Incident Scenarios
- Queue backlog growth causing delayed reminders.
- DB failover event causing transient write failures.
- Regional dependency outage (payment or messaging provider).

## Runbook Requirements
- Severity model with paging thresholds and ownership.
- Triage checklist: blast radius, data integrity risk, workaround status.
- Communication cadence to clinics and support teams.

## Downtime Workflow
1. Declare degraded mode and freeze non-essential writes.
2. Activate offline clinic procedures and fallback roster exports.
3. Resume services, replay backlog, and verify consistency.
4. Publish reconciliation reports and customer communications.

## Post-Incident
- Perform blameless postmortem within 2 business days.
- Track corrective actions with due dates and owners.
