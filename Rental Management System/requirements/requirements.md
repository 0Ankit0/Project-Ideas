...
## Implementation-Specific Addendum: Normative acceptance criteria

### Domain-level decisions
- Add measurable acceptance criteria for lifecycle timing, pricing accuracy, and conflict response.
