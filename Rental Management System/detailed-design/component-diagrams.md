...
graph TB
    ...
    subgraph "Domain Modules"
        ...
        AssetModule[Asset & Listing Module]
        ...
        AssessmentModule[Condition Assessment Module]
...
```mermaid
graph LR
    subgraph "Booking Module (example)"
        direction TB
...
graph TB
    subgraph "Async Worker"
        ...
        subgraph "Job Handlers"
            BookingReminderJob[Booking Reminder Job]
...
## Implementation-Specific Addendum: Module contracts

### Why this diagram matters
Define synchronous APIs vs asynchronous events per module boundary.

### Mermaid implementation scenario
```mermaid
flowchart LR
    A[ComponentDiagramsStart] --> B[Validate booking window and policy version]
