...
graph TB
    subgraph "REST API Container"
        ...
        subgraph "Asset & Listing Component"
...
| Asset Service | Asset CRUD, availability management, search |
...
| Booking Service | Booking creation, confirmation, modification, cancellation, return |
