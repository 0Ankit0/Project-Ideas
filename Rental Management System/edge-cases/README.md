# Rental Management System Edge Cases

This package documents cross-sector rental edge cases (property, vehicle,
equipment, and event inventory) with detection, compensation, and runbooks.
## Implementation-Specific Addendum: Scenario taxonomy

### Domain-level decisions
- Classify edge cases by lifecycle stage, financial risk, and customer impact.
