...
- Separate inference gateway, policy decision service, review orchestration, and model-governance services to reduce coupling and improve auditability.
---
...
flowchart LR
    API --> Orchestrator
    Orchestrator --> OCRAdapter
    Orchestrator --> Classifier
    Orchestrator --> Extractor
    Orchestrator --> ThresholdEngine
    ThresholdEngine --> ReviewQueue
```
