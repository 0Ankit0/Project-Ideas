...
- Define SLOs for auto-processing rate, review turnaround, calibration health, and rollback MTTR; integrate these into on-call dashboards and weekly governance reviews.
---
...
### On-Call Runbook Detail
- **SEV-1**: export corruption risk -> disable auto-accept policy, drain queues, notify compliance lead.
- **SEV-2**: OCR provider partial outage -> activate fallback provider and increase review capacity.
- **SEV-3**: calibration drift -> tighten thresholds and schedule emergency recalibration job.
- Include hour-by-hour comms template, stabilization criteria, and follow-up artifact requirements.
