...
- Represent online inference, offline training, and governance planes separately to show secure data movement and operational ownership.
---
...
### Mermaid: Logical Architecture (Production)
```mermaid
flowchart LR
    Ingest --> Orchestrator --> Inference
    Inference --> Policy
    Policy --> Export
    Policy --> Review
    Review --> Feedback
