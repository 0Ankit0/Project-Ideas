...
This catalog defines stable event contracts for **E-Commerce** to support event-driven integrations, auditability, and analytics across e commerce workflows.
