...
This document defines enforceable policy rules for **E-Commerce** so command processing, asynchronous jobs, and operational actions behave consistently under normal and exceptional conditions.

## Context
- Domain focus: e commerce workflows.
