...
## 1. Delivery Goal
Ship a production-ready system for **multi-vendor catalog, cart, checkout, payment, fulfillment, and returns**.

### Target KPIs
- Checkout success > 98%, Order API p95 < 250ms, Inventory sync lag < 30s
- Availability target: 99.9%
- Mean time to recovery (MTTR): < 30 minutes

## 2. Implementation Scope (Must-Have)
Core services to implement:
- Identity, Catalog, Search, Cart, Checkout, Payment, Order, Shipping, Returns
