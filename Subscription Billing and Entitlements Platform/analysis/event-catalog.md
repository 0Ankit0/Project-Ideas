...
This catalog defines stable event contracts for **Subscription Billing and Entitlements Platform** to support event-driven integrations, auditability, and analytics across subscription billing and entitlements workflows.
