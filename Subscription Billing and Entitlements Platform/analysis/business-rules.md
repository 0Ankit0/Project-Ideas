...
This document defines enforceable policy rules for **Subscription Billing and Entitlements Platform** so command processing, asynchronous jobs, and operational actions behave consistently under normal and exceptional conditions.

## Context
- Domain focus: subscription billing and entitlements workflows.
