...
This data dictionary is the canonical reference for **Content Management System**. It defines shared terminology, entity semantics, and governance controls required to keep content management workflows consistent across teams and services.
