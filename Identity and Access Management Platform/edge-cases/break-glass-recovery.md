...
## Trigger Conditions
- Primary IdP outage with business-critical access requirement.
- Security incident requiring emergency privileged intervention.

## Control Requirements
- Time-boxed emergency roles with strict scope and mandatory justification.
- Dual authorization for issuance and mandatory out-of-band approval record.
- Continuous session recording and elevated real-time alerting.

## Recovery Steps
1. Activate break-glass mode via signed admin workflow.
2. Grant minimal emergency role and enforce step-up MFA.
3. On incident close, revoke emergency grants and run post-event review.
...
- Access review of all emergency actions and evidence export.
- Policy adjustments and guardrails tracked to closure.
