...
## Objective
Provide implementation-ready guidance for **C4 Code Diagram** in the Messaging and Notification Platform.
...
flowchart TD
  ...
  Service --> Publisher[OutboxPublisher]
  Worker[DispatchWorker] --> Router[ProviderRouter]
  Router --> Adapter[ChannelAdapter]
  Worker --> AttemptRepo[DeliveryAttemptRepository]
```
