...
## Objective
Provide implementation-ready guidance for **Class Diagrams** in the Messaging and Notification Platform.
...
classDiagram
  ...
  NotificationRequest --> TemplateVersion : uses
  NotificationRequest --> DeliveryAttempt : generates
  NotificationRequest --> ConsentRecord : evaluatedAgainst
```
