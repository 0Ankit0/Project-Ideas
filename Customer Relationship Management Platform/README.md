# Customer Relationship Management Platform Design Documentation

> Comprehensive system design documentation for lead lifecycle, account ownership, opportunity pipeline, and revenue forecasting.
...
### Actors
- **Sales Representative** - participates in CRM workflows
- **Sales Manager** - participates in CRM workflows
- **Revenue Operations Analyst** - participates in CRM workflows
- **Customer Success Manager** - participates in CRM workflows
- **Administrator** - participates in CRM workflows

### Key Features
- Lead capture and qualification with auditability and operational controls
- Deduplication and merge review with auditability and operational controls
- Opportunity stage progression with auditability and operational controls
- Territory assignment and reassignment with auditability and operational controls
- Forecast rollup and approval with auditability and operational controls
...
- ✅ Includes domain deep-dive (`detailed-design/lead-scoring-and-deduplication.md`) and operational edge-case pack.
