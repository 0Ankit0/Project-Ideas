...
High-level design artifact describing system topology, responsibilities, and cross-service event propagation.
...
- Prefer asynchronous integration between bounded contexts.
- Keep state transitions in one authoritative domain service.
- Protect downstream systems from duplicate and out-of-order events.
