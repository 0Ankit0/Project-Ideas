...
This document defines enforceable policy rules for **Logistics Tracking System** so command processing, asynchronous jobs, and operational actions behave consistently under normal and exceptional conditions.

## Context
- Domain focus: logistics tracking workflows.
