...
This catalog defines stable event contracts for **Logistics Tracking System** to support event-driven integrations, auditability, and analytics across logistics tracking workflows.
