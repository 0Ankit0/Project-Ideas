...
- Keep policy versions explicit and update this section whenever business rules change.
- Link each policy to owning team and rollout plan for backward compatibility.
