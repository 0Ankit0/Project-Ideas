...
This catalog defines stable event contracts for **Smart Recommendation Engine** to support event-driven integrations, auditability, and analytics across smart recommendation engine workflows.
