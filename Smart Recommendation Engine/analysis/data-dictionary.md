...
This data dictionary is the canonical reference for **Smart Recommendation Engine**. It defines shared terminology, entity semantics, and governance controls required to keep smart recommendation engine workflows consistent across teams and services.
