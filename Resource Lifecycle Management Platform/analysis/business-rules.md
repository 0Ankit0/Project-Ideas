...
This document defines enforceable policy rules for **Resource Lifecycle Management Platform** so command processing, asynchronous jobs, and operational actions behave consistently under normal and exceptional conditions.

## Context
- Domain focus: resource lifecycle management workflows.
